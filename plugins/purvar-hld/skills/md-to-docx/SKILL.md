...
name: md-to-docx
description: >-
  This skill should be used when the user needs to convert a Markdown file to a formatted Word document (.docx).
  It uses pandoc + reference-doc template + python-docx post-processing.
  Typical requests: "转Word", "生成docx", "md转word", "markdown转文档", "/md-to-docx".
  Not for: creating Markdown content from scratch or converting other formats.
---
