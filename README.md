...
| 插件 | 说明 | 安装命令 |
|------|------|----------|
| adhd-pm | ADHD 友好的个人项目管理 skill 模板：飞书多维表格 Base 的 10 种高频操作稳定工作流（加任务/完成/查今日/周报导入），内嵌 7 条 ADHD 行为规则。首次使用需自建 Base 并按 schema.md 填 id | `/plugins install adhd-pm@henry-hub` |
